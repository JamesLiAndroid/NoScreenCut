...
public class MainActivity extends AppCompatActivity implements Synthesizing.OnSynthListener {
    ...
    // 测试数据
    public static final String TEST_DATA = " [{\"createDate\":\"2018-05-09 08:57:19\",\"workStatus\":\"待机中\"},{\"createDate\":\"2018-05-09 08:57:33\",\"workStatus\":\"工作中\"},{\"createDate\":\"2018-05-09 08:57:41\",\"workStatus\":\"工作中\"}]";
    ...
    public void onAssemble(View v){
        ...
        try{
           //  mSynthesizing.create(name,nationality,type);
            mSynthesizing.create(TEST_DATA);
        }catch (Exception e){
            e.printStackTrace();
